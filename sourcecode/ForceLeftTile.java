 ...
 */
public class ForceLeftTile extends Tiles {

    /**
     * This constructor is for a new ForceLeftTile with its appropriate char symbol and sprite image
     */
    public ForceLeftTile() {
        super('<');
        sprite = new ImageIcon("ForceLeftTile.png");
    }
