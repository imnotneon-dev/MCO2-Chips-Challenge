...
/**
 * This tile represents a PurpleTeleporter tile on the map. They are considered teleportation tiles
 * and they are can be teleported upon when chip has a teleportation device in his inventory
 */
public class PurpleTeleporter extends Tiles {
    
    /**
     * This constructor is for a new PurpleTeleporter with its appropriate char symbol and sprite image
     */
    public PurpleTeleporter() {
        super('P');
        sprite = new ImageIcon("PurpleTeleporter.png");
    }

    /**
     * Determines whether chip can walk over the tile
     * PurpleTeleporter tiles are walkable and when chip has a teleportation device in his inventory the
     * effect changes
     * 
